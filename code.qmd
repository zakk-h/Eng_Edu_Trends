...
m1 <- lm(highest_level_qualification_achieved_by_age_22_level_6_or_above ~  population_2011 + highest_level_qualification_achieved_b_age_22_average_score+ level_3_at_age_18	+ activity_at_age_19_employment_with_earnings_above_10_000 + key_stage_4_attainment_school_year_2012_to_2013		, data = english_education)
summary(m1)
...
ggplot(m1, aes(x = .fitted, y = .resid)) + 
  ...
  labs(x = "Fitted (predicted) value", y = "Residual", title = "Linearity looks great, Constant variance looks sufficient") + 
  theme_bw()
...
ggplot(m1, aes(sample = .resid)) +
  ...
  labs(x = "Theoretical quantiles", 
       y = "Sample quantiles", title = "Deviation from left of QQ plot but acceptable, isolated incident")
...
ggplot(m1_aug, aes(x = .resid)) + 
  ...
  stat_function(fun = dnorm, 
                ...
                color = "darkred", lwd = 2) +
  labs(x = "Residual", y = "Density", title = "Long left tail but normality of residuals looks great") + 
  theme_bw()
